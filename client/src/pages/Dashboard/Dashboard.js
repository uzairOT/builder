      ...
      <main>
        <Grid sx={themeStyle.dashboard} container pt={1} >
          ...
          <Grid item xs={12} sm={9} md={7} height={'100%'} overflow={'hidden'} >
            <Grid item margin={1} ml={2} mr={2}><Paper sx={{ ...themeStyle.dashboardViews, borderRadius: '14px' }}><WeatherView userGreetings={"Good Morning, Admin"} dailyForecast={dailyForecast} loading={loading} error={error} /></Paper></Grid>
