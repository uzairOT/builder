...
useEffect(()=>{
  ...
  return (
    ...
    <Grid item xl={2} lg={2} md={4} sm={12} xs={12} height={"93vh"} sx={{display:{xs:"none",sm:"block"}, }}>
          <Paper sx={{ height: "100%", borderRadius: "14px" }}>
            <Typography sx={themeStyle.title} p={2} pb={1.5}>Projects Dashboard</Typography>
            <ProjectsSidebar />
          </Paper>
        </Grid>
        <Grid item  xl={10} lg={10} md={8} sm={12} xs={12}  pr={1}  height={{xl:"93vh" ,lg:'93vh', md:'calc(93vh + 15px)', sm:'93vh', xs:'93vh' }} sx={themeStyle.scrollable} overflow={'hidden'}>
