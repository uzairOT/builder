  ...
  return (
    <div style={{ width: "100%", height: "100vh", marginBottom: "1rem" }}>
      ...
      <Box sx={themeStyle.titleBox}>
        ...
        <Button
          sx={{ ...YellowBtn, ...themeStyle.buttonStyle }}
          onClick={handleOpen}
        >
          Make Payment
        </Button>
      ...
      <Box sx={{ ...themeStyle.titleBox, ...themeStyle.evenBox }}>
        {invoiceData.map((item, index) => (
          <Box key={index} sx={themeStyle.amountBox}>
            <Typography sx={themeStyle.titleTypo}>{item.title}</Typography>
            <Typography
              sx={{ ...themeStyle.titleTypo, ...themeStyle.amountSize }}
            >
              {item.amount}
            </Typography>
          </Box>
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={themeStyle.tableHeadings}>
                Invoices Amount
              </TableCell>
            ...
            {rows.map((row, index) => (
              <React.Fragment key={row.name}>
                <TableRow>
                  ...
                  <TableCell sx={themeStyle.tableRowText}>
                    {row.invoicesAmount}
                  </TableCell>
                  <TableCell sx={themeStyle.tableRowText}>
                    {row.AmountPaid}
